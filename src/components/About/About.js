      ...
      <CardContent className={styles.p_0}>
        <header className={styles.header}>
          <div className={styles.wrapperImg}>
            <a href="https://crazysouslik.pro" target="_blank">
              <img src={src_avatar} alt={name} className={styles.avatar}/>
            </a>            
          </div>
          <div className={styles.contact_wrapper}>
            <h1 className={styles.title}>Владимир Сысоев</h1>
            <span className={styles.text}>Junior frontend-разработчик</span>
            <a href="mailto:crazysouslik@ya.ru" className={styles.contacts_link}>
              <img src="../images/email.svg"alt="E-mail CrazySouslik`s" />
          ...
          <div className={styles.social}>
            <a href="https://t.me/CrazySouslik" className={styles.social__item} target="_blank">
              <img src="../images/tg.svg" alt="Telegram CrazySouslik`s"/>
            </a>
            <a href="https://github.com/ChuVo" className={styles.social__item} target="_blank">
              <img src="../images/git.svg" alt="GitHub CrazySouslik`s"/>
            </a>
            <a href="https://www.linkedin.com/in/vladimir-sysoev-571a97176/" className={styles.social__item} target="_blank">
              <img src="../images/in.svg" alt="LinkedIn CrazySouslik`s"/>
            </a>
            <a href="https://vk.com/chuiv" className={styles.social__item} target="_blank">
              <img src="../images/vk.svg" alt="vk CrazySouslik`s"/>
            </a>
          </div>         
        </header>
